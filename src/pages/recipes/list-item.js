...
const RecipesListItem = ({ recipe }) => {
	...
	return (
		<div className="flex flex-col sm:flex-row border border-[var(--foreground)] rounded mb-5 items-center">
			<Image
				src={recipe.image}
				alt={recipe.name}
				width={100}
				...
				loading="lazy"
				className="rounded m-2 items-center justify-center text-center"
			/>
			<div className="flex-grow flex flex-col m-4 gap-y-3">
